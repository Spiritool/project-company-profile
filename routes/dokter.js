...
router.get('/cari', async function(req, res) {
    ...
    try {
        ...
        let dokter = []; 
        if(id_keahlian == "Pilih Keahlian" && hari=="Pilih Hari" && nama_dokter == 'Pilih Dokter'){
            dokter = await Model_Jadwal.getAll();
        }else if(id_keahlian == "Pilih Keahlian"){
            dokter = await Model_Dokter.getDokterHari(hari);
            console.log("fungsi dua")
        } else if(hari=="Pilih Hari"){
            dokter = await Model_Dokter.getDokterKeahlian(id_keahlian);
            console.log("fungsi tiga")
        } else if(nama_dokter == 'Pilih Dokter' && id_keahlian == null ){
